...
type LogFun = string -> unit
type RetrieveSrcFileFun = SupportedFileInfo -> Async<Result<RetrievedFileContent, string>>
type ToPdfFun = string -> Async<Result<ConversionResult, string>>
type WritePdfFileToStorageFun = ConvertedFileContent -> Async<Result<StoredFileContent, string>>
type WorkflowFun = string -> Async<Result<WorkflowResult, string>>
